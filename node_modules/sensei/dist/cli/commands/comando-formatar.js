...
export function comandoFormatar(aplicarFlagsGlobais) {
    return new Command('formatar')
        .description('Aplica a formatação interna estilo Sensei (whitespace, seções, finais de linha)')
        ...
        try {
            ...
            const engineRaw = String(opts.engine || process.env.SENSEI_FORMAT_ENGINE || 'auto').trim();
