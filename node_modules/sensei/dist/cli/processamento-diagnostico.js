...
export async function processarDiagnostico(opts) {
    ...
    try {
        ...
        if (config.GUARDIAN_ENABLED) {
            log.fase?.('Verificando integridade do Sensei');
            try {
        ...
        if (arquetiposResultado) {
            ...
            if (opts.json) {
                ...
                const parseErrosGlobais = globalThis.__SENSEI_PARSE_ERROS__ || [];
                const parseErrosOriginais = globalThis.__SENSEI_PARSE_ERROS_ORIGINAIS__ || 0;
            ...
            if (!opts.json && !config.SCAN_ONLY) {
                ...
                if (!config.COMPACT_MODE && !process.env.__SENSEI_TUDO_PRONTO_EMITIDO) {
                    ...
                    process.env.__SENSEI_TUDO_PRONTO_EMITIDO = '1';
                }
                if (process.env.VITEST) {
                    log.info(CliProcessamentoDiagnosticoMensagens.diagnosticoConcluido);
                }
