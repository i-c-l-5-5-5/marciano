import { type SenseiFilePath } from './paths.js';
...
export declare function readJSON<T = unknown>(fileCaminho: SenseiFilePath | string, options?: ReadOptions<T>): Promise<T>;
export declare function writeJSON<T = unknown>(fileCaminho: SenseiFilePath | string, data: T, options?: WriteOptions): Promise<void>;
export declare function deleteJSON(fileCaminho: SenseiFilePath | string, options?: {
    backup?: boolean;
}): Promise<void>;
