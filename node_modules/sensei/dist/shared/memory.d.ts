import type { MemoryMessage, SenseiContextState, SenseiRunRecord } from '../types/index.js';
...
export declare class SenseiContextMemory {
    private maxRuns;
    private persistCaminho?;
    private state;
...
export declare function getDefaultContextMemory(): Promise<SenseiContextMemory>;
